...
def device_sharing(node_id, url_avail=True):
    ...
    try:
        ...
        # generate connection url for the node
            ...
            command = f"node meshctrl DeviceSharing --id {node_id} --add infraon_desktop --type desktop --consent prompt  --url {WSS_URL} --loginuser '{MESH_CENTRAL_USERNAME}' --loginpass '{MESH_CENTRAL_PASSWORD}' "
